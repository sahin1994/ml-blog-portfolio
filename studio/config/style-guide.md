House style for this blog. Edit this file (or the studio Settings panel) to change
the voice — the MCP server, the studio AI panel, and the CLI draft studio all read
it live.
